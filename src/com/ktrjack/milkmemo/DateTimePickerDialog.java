...
public class DateTimePickerDialog extends AlertDialog implements OnClickListener, OnDateChangedListener, OnTimeChangedListener{
	...
	/**
	 * The callback used to indicate the user is one filling in the date.
	 * ユーザの入力値を取得するコールバックインターフェース
	 */
	public static interface OnDateTimeSetListener {
		/**
		 * @param viewe The view assoiated with this listener.
		 * @param year The year that was set.
		 * @param monthOfYear The month that was set (0-11) for compatibility
		 * with {@link java.util.Calendar}.
		 * @param dayOfMonth The day of the month that was set.
		 * @param hourOfDay The hour of the day that was set.
		 * @param minute The minute of that was set.
		 */
		void onDateTimeSet(DatePicker datePickerView, TimePicker timePickerView, int year,
				int monthOfYear, int dayOfMonth, int hourOfDay, int minute);
	}
	/**
	 * DatePickerDialogとTimePickerDialogを利用しダイアログ作成
	 *
